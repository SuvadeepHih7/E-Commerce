    ...
    <div className="p-4 bg-white/90 backdrop-blur-sm w-full rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 border border-white/50 hover:border-[#2E8B57]/20 group">
      ...
      <div className="p-4 pt-0">
        ...
        <div className="flex justify-between items-center mb-4">
          <span className="font-bold text-[#2E8B57] text-2xl">${product.price}</span>
        ...
        {/* view button*/}
         <button 
          ...
          className={"cursor-pointer w-full py-3 px-4 rounded-xl font-semibold text-white transition-all duration-300 flex items-center justify-center space-x-2 bg-gradient-to-r from-[#2E8B57] to-[#3CB371] hover:from-[#228B22] hover:to-[#2E8B57] shadow-lg hover:shadow-xl hover:scale-105 transform"}>
            View Product
        </button>
      </div>
    </div>
